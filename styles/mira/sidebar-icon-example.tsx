...
import {
  ...
  AvatarFallback,
  AvatarImage,
} from "@/styles/mira/ui/avatar"
import { Button } from "@/styles/mira/ui/button"
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
} from "@/styles/mira/ui/collapsible"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton tooltip={item.title} asChild>
                      <CollapsibleTrigger>
                        ...
                        <ChevronRightIcon className="ms-auto transition-transform duration-100 group-data-open/collapsible:rotate-90" />
                      </CollapsibleTrigger>
                    </SidebarMenuButton>
                    <CollapsibleContent>
                      <SidebarMenuSub>
