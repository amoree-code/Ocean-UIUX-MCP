...
import {
  ...
  AlertDialogTitle,
  AlertDialogTrigger,
} from "@/styles/vega/ui/alert-dialog"
import { Badge } from "@/styles/vega/ui/badge"
import { Button } from "@/styles/vega/ui/button"
import { ButtonGroup } from "@/styles/vega/ui/button-group"
import {
  Card,
  CardContent,
  CardDescription,
  CardHeader,
  CardTitle,
} from "@/styles/vega/ui/card"
import { Checkbox } from "@/styles/vega/ui/checkbox"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
  ...
  DropdownMenuTrigger,
} from "@/styles/vega/ui/dropdown-menu"
import { Field, FieldGroup } from "@/styles/vega/ui/field"
import {
  InputGroup,
  InputGroupAddon,
  InputGroupInput,
  InputGroupText,
} from "@/styles/vega/ui/input-group"
import {
  Item,
  ItemActions,
  ItemContent,
  ItemDescription,
  ItemTitle,
} from "@/styles/vega/ui/item"
import {
  RadioGroup,
  RadioGroupItem,
} from "@/styles/vega/ui/radio-group"
import { Slider } from "@/styles/vega/ui/slider"
import { Switch } from "@/styles/vega/ui/switch"
import { Textarea } from "@/styles/vega/ui/textarea"
          ...
          <Card className="w-full">
            <CardContent className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <Switch defaultChecked className="ms-auto" />
              </div>
            </CardContent>
          </Card>
        </div>
