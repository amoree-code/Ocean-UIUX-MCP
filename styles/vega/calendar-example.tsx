...
import { Calendar, CalendarDayButton } from "@/styles/vega/ui/calendar"
import { Card, CardContent, CardFooter } from "@/styles/vega/ui/card"
      ...
      <Field className="mx-auto w-72">
        <Popover open={open} onOpenChange={setOpen}>
          ...
          <PopoverTrigger asChild>
            ...
            >
              {date ? format(date, "PPP") : <span>Pick a date</span>}
              <ChevronDownIcon data-icon="inline-start" className="ms-auto" />
            </Button>
          </PopoverTrigger>
          <PopoverContent className="w-auto p-0" align="start">
            <Calendar
