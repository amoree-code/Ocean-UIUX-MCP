...
import {
  ...
  BubbleGroup,
  BubbleReactions,
} from "@/styles/luma/ui/bubble"
import { Button } from "@/styles/luma/ui/button"
import {
  Collapsible,
  CollapsibleTrigger,
} from "@/styles/luma/ui/collapsible"
import { Marker, MarkerContent } from "@/styles/luma/ui/marker"
              ...
              {isLong ? (
                <CollapsibleTrigger asChild>
                  ...
                  >
                    ...
                    <ChevronDownIcon data-icon="inline-end" className="group-data-open/button:rotate-180" />
                  </Button>
                </CollapsibleTrigger>
              ) : null}
            </BubbleContent>
